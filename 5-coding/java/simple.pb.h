...
class SimpleMessage final :
 ...
 public:
  ...
  private:
  int32_t _internal_sample_list(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_sample_list() const;
  void _internal_add_sample_list(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_sample_list();
  public:
  int32_t sample_list(int index) const;
  void set_sample_list(int index, int32_t value);
  void add_sample_list(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      sample_list() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_sample_list();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > sample_list_;
...
inline int32_t SimpleMessage::_internal_id() const {
  return id_;
}
inline int32_t SimpleMessage::id() const {
  // @@protoc_insertion_point(field_get:example.simple.SimpleMessage.id)
  return _internal_id();
}
inline void SimpleMessage::_internal_set_id(int32_t value) {
  
  id_ = value;
}
inline void SimpleMessage::set_id(int32_t value) {
...
inline int32_t SimpleMessage::_internal_sample_list(int index) const {
  return sample_list_.Get(index);
}
inline int32_t SimpleMessage::sample_list(int index) const {
  // @@protoc_insertion_point(field_get:example.simple.SimpleMessage.sample_list)
  return _internal_sample_list(index);
}
inline void SimpleMessage::set_sample_list(int index, int32_t value) {
  sample_list_.Set(index, value);
  // @@protoc_insertion_point(field_set:example.simple.SimpleMessage.sample_list)
}
inline void SimpleMessage::_internal_add_sample_list(int32_t value) {
  sample_list_.Add(value);
}
inline void SimpleMessage::add_sample_list(int32_t value) {
